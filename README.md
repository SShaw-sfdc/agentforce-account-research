...
| Agent Topics | `Agentforce_Account_Research_AEA` (Orchestrator), `In_Depth_Web_Research` (Researcher) |
...
```
https://login.salesforce.com/packaging/installPackage.apexp?p0=04tKY000000hnyW
```
...
1. Configure the Research Sub-Agent (Employee Agent with `In_Depth_Web_Research` topic)
2. Configure the User-Facing Agent (add `Agentforce_Account_Research_AEA` topic)
